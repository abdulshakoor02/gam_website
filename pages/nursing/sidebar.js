...
import Canada from "../../api/nursing";
    ...
    <div className="sidebar-widget">
      <div className="widget">
        <ul className="widget-category list-unstyled">
          {Canada.slice(0, 8).map((service, Pitem) => (
            <li key={Pitem}>
              {service.title ? (
                <Link
                  onClick={ClickHandler}
                  href={"/nursing/[slug]"}
                  as={`/nursing/${service.slug}`}
                >
                  {service.title}
                  <span>
                    <Image src={sicon} alt="" />
              ...
              <div className="xb-download">
                <div className="xb-item--inner">
                  ...
                  <h4 className="xb-item--title">
                    TOEFL <br /> Application Form
                  </h4>
                  <div className="xb-item--size">3.9 KB</div>
                </div>
              </div>
            </Link>
          </li>
...
*/}
      ...
      >
        ...
        <Link onClick={ClickHandler} className="thm-btn" href="/contact">
          Get in Touch
        </Link>
      </div>
    </div>
